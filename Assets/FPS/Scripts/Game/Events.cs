...
namespace Unity.FPS.Game
{
    ...
    public static class Events
    {
        ...
        public static FuelCollectEvent FuelCollectEvent = new FuelCollectEvent();
        public static ReturnToSpaceShipEvent ReturnToSpaceShipEvent = new ReturnToSpaceShipEvent();
    ...
    public class FuelCollectEvent : GameEvent
    {
        public GameObject Fuel_Item;
        public int RemainingFuelCount;
    }

    public class ReturnToSpaceShipEvent : GameEvent
    {
    }
